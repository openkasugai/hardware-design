...
set hls_dir "../../src/hls"
set cflags "-std=c++1y -I${include_dir} -I${hls_dir} -DCSC_BD_TOP -DFW_KRNL_HLS_TOP -DCSC_LOCAL_VERSION=0x${krnl_version}"
add_files ${hls_dir}/chain_subblock.cpp -cflags "$cflags"
add_files ${hls_dir}/barrel_shifter.cpp -cflags "$cflags"
