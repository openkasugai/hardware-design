...
//start convert FUNCTION module_name
...
//end
    ...
    output [(1<<DW_LOG)-1:0]     out_OPORT_NUM_tdata,
    output [(1<<(DW_LOG-3))-1:0] out_OPORT_NUM_tkeep,
    output [CTX_ID_BITS-1:0]     out_OPORT_NUM_tuser,
    output [TDEST_BITS-1:0]      out_OPORT_NUM_tdest,
    output                       out_OPORT_NUM_tlast,
    output                       out_OPORT_NUM_tvalid,
    input                        out_OPORT_NUM_tready,
    //end
    //start generate IPORT_NUM IPORT_NUM
   ...
   localparam [OPORT_MAX-1:0] OPORT_HEADER_UPDATE = {OPORT_NUM{1'b1}};
   //end

   //start generate IPORT_NUM IPORT_NUM
   wire [(1<<DW_LOG)-1:0]        func_in_IPORT_NUM_tdata;
   wire [(1<<(DW_LOG-3))-1:0]    func_in_IPORT_NUM_tkeep;
   wire [CTX_ID_BITS-1:0]        func_in_IPORT_NUM_tuser;
   wire                          func_in_IPORT_NUM_tlast; // eof
   wire                          func_in_IPORT_NUM_tvalid;
   wire                          func_in_IPORT_NUM_tready;
   //end
   //start generate OPORT_NUM OPORT_NUM
   wire [(1<<DW_LOG)-1:0]        func_out_OPORT_NUM_tdata;
   wire [(1<<(DW_LOG-3))-1:0]    func_out_OPORT_NUM_tkeep;
   wire [CTX_ID_BITS-1:0]        func_out_OPORT_NUM_tuser;
   wire                          func_out_OPORT_NUM_tlast; // eof
   wire                          func_out_OPORT_NUM_tvalid;
   wire                          func_out_OPORT_NUM_tready;
   //end
   //start generate IPORT_NUM IPORT_NUM
   wire [63:0]                   func_in_addr_IPORT_NUM;
   wire [31:0]                   func_in_size_IPORT_NUM;
   //end
   //start generate OPORT_NUM OPORT_NUM
   wire [63:0]                   func_out_addr_OPORT_NUM;
   wire [31:0]                   func_out_size_OPORT_NUM;
   //end
   //start generate_unbound OPORT_NUM OPORT_NUM
   wire [63:0]                   func_out_updated_addr_OPORT_NUM;
   wire [31:0]                   func_out_updated_size_OPORT_NUM;
   wire                          func_out_updated_valid_OPORT_NUM;
   //end
   wire                          ap_start;
   wire                          ap_idle;
   wire                          ap_done;
   ...
   function_ctrl #(
       ...
       //end
       //start aggregate OPORT_NUM OPORT_NUM
       .func_out_updated_addr ( func_out_updated_addr_OPORT_NUM ),
       .func_out_updated_size ( func_out_updated_size_OPORT_NUM ),
       .func_out_updated_valid ( func_out_updated_valid_OPORT_NUM ),
       //end
       .func_ap_start ( ap_start ),
       .func_ap_idle ( ap_idle ),
       .func_ap_done ( ap_done ),
       .func_ap_ready ( ap_ready ),
       .clk ( clk ),
       .resetn ( resetn )
   );
