...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "IDEST_BITS" -parent ${Page_0}
...
proc update_PARAM_VALUE.IDEST_BITS { PARAM_VALUE.IDEST_BITS } {
	# Procedure called to update IDEST_BITS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.IDEST_BITS { PARAM_VALUE.IDEST_BITS } {
	# Procedure called to validate IDEST_BITS
	return true
}
...
proc update_MODELPARAM_VALUE.IDEST_BITS { MODELPARAM_VALUE.IDEST_BITS PARAM_VALUE.IDEST_BITS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.IDEST_BITS}] ${MODELPARAM_VALUE.IDEST_BITS}
}
