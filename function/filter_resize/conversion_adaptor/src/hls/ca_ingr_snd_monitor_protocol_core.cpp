...
static constexpr int DATA_WIDTH_BYTES = 4;
static constexpr int REQ_BURST_LENGTH_NZ = 1;
static constexpr int RESP_BURST_LENGTH_EQ_REQ = 1;

void ca_ingr_snd_monitor_protocol_core(bool &req_ready,
                                       bool &req_valid,
                                       sessionReq &req_data,
                                       bool &resp_ready_0,
                                       bool &resp_valid_0,
...
#pragma HLS stream variable = resp_queue_1 depth = OUTSTANDING_NUM
    hls::stream<uint32_t> data_queue;
#pragma HLS stream variable = data_queue depth = (OUTSTANDING_NUM + 1)
    ...
    check_resp_data<DATA_WIDTH_BYTES, uint32_t>(resp_queue_1,
                                             data_queue,
