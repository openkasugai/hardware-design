...
// Protocol monitoring error bit field definition (filter/size)
static constexpr int FR_PROTOCOL_FAULT_RESP_CHANNEL_EQ_REQ = 0;
static constexpr int FR_PROTOCOL_FAULT_RESP_BURST_LENGTH_LE_REQ = 1;
static constexpr int FR_PROTOCOL_FAULT_RESP_SOF_EQ_REQ = 2;
static constexpr int FR_PROTOCOL_FAULT_RESP_EOF_EQ_REQ = 3;
static constexpr int FR_PROTOCOL_FAULT_RESP_BURST_LENGTH_EQ_REQ = 4;
