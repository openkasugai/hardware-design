...
# module references:
# axis_ddu_sink, axis_ddu_sink, axis_ddu_sink, axis_ddu_sink, axis_dkuld_sink, axis_dkulid_sink, axis_du_sink, nop_st_wrapper, axis_ddu_sink, axis_ddu_sink, axis_dkulid_sink, axis_ddu_sink, nop_mm_wrapper
...
connect_bd_intf_net -intf_net [get_bd_intf_nets xdma_0_M_AXIS_H2C_2] [get_bd_intf_pins xdma_0/M_AXIS_H2C_2] [get_bd_intf_pins system_ila_rx/SLOT_2_AXIS]
  ...
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins proc_sys_reset_ddr0/slowest_sync_clk] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK]
