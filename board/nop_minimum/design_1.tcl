...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_SI {1} $if_header_switch
  ...
  set_property CONFIG.NUM_SI {1} $of_header_switch
  ...
  set_property CONFIG.NUM_SI {1} $idata_switch
  ...
  set_property CONFIG.NUM_SI {1} $if_header_consume_switch
  ...
  set_property CONFIG.NUM_SI {1} $if_consume_switch
  ...
  set_property CONFIG.NUM_SI {1} $of_complete_switch
  ...
  set_property CONFIG.NUM_SI {1} $odata_switch
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_interconnect_0_M01_AXI] [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins system_ila_rx/SLOT_4_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets xdma_0_M_AXI_BYPASS] [get_bd_intf_pins xdma_0/M_AXI_BYPASS] [get_bd_intf_pins system_ila_rx/SLOT_3_AXI]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins route_controller_0/out_frame_consume_tvalid]
